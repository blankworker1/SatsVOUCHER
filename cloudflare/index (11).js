...
// ── HUB ───────────────────────────────────────────────────────
// Main splash screen — entry point for all merchant flows

const HUB = page('Sats VOUCHER', `
<div class="app">
  <div class="hdr">
    <div id="logo"></div>
    <div id="storeName" style="font-size:12px;color:var(--mut);font-weight:600"></div>
  </div>
  <div class="scroll" style="display:flex;flex-direction:column;gap:10px;padding-top:16px">

    <button onclick="go('/app/sale')" style="
      width:100%;padding:18px 16px;border-radius:14px;
      background:var(--gold);border:none;cursor:pointer;
      display:flex;align-items:center;gap:14px;text-align:left">
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0a0a0a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>
      <div>
        <div style="font-family:'Barlow Condensed',sans-serif;font-weight:900;font-size:20px;color:#0a0a0a;letter-spacing:.5px;text-transform:uppercase">SatsVOUCHER</div>
        <div style="font-size:11px;color:#333;margin-top:2px">Issue and manage paper vouchers</div>
      </div>
    </button>

    <button onclick="go('/app/satscash')" style="
      width:100%;padding:18px 16px;border-radius:14px;
      background:var(--sur);border:1px solid var(--gold);cursor:pointer;
      display:flex;align-items:center;gap:14px;text-align:left">
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#FFD000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>
      <div>
        <div style="font-family:'Barlow Condensed',sans-serif;font-weight:900;font-size:20px;color:var(--gold);letter-spacing:.5px;text-transform:uppercase">SatsCASH</div>
        <div style="font-size:11px;color:var(--mut);margin-top:2px">Mint and redeem NFC coins</div>
      </div>
    </button>

    <button onclick="go('https://pay.blink.sv/satsvoucher')" style="
      width:100%;padding:18px 16px;border-radius:14px;
      background:var(--sur);border:1px solid #1e3a2a;cursor:pointer;
      display:flex;align-items:center;gap:14px;text-align:left">
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00cc55" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
      <div>
        <div style="font-family:'Barlow Condensed',sans-serif;font-weight:900;font-size:20px;color:#00cc55;letter-spacing:.5px;text-transform:uppercase">Lightning POS</div>
        <div style="font-size:11px;color:var(--mut);margin-top:2px">Accept Lightning payments via Blink</div>
      </div>
    </button>

    <div style="display:flex;gap:10px;margin-top:4px">
      <button onclick="go('/app/history')" style="
        flex:1;padding:14px;border-radius:14px;
        background:var(--sur);border:1px solid var(--bdr);cursor:pointer;
        display:flex;flex-direction:column;align-items:center;gap:6px">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
        <span style="font-size:12px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:.5px">History</span>
      </button>
      <button onclick="go('/app/settings')" style="
        flex:1;padding:14px;border-radius:14px;
        background:var(--sur);border:1px solid var(--bdr);cursor:pointer;
        display:flex;flex-direction:column;align-items:center;gap:6px">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>
        <span style="font-size:12px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:.5px">Settings</span>
      </button>
    </div>
...
<div class="app">
  <div class="hdr">
    <button class="back" onclick="go('/app/sale')">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FFD000" stroke-width="2.5" stroke-linecap="round"><polyline points="15 18 9 12 15 6"/></svg>
      New Sale
    </button>
    <div id="logo"></div>
  ...
  <div class="scroll">
    ...
    <button class="btn-p" id="nsbtn" style="display:none" onclick="go('/app/sale')">New Sale</button>
...
<div class="app">
  ...
  <div class="scroll">
    ...
    <div id="stepDone" style="display:none;text-align:center;padding:20px 0">
      ...
      <div id="doneSats" style="font-family:'DM Mono',monospace;font-size:14px;color:#888;margin-bottom:4px"></div>
      <div id="doneFiat" style="font-family:'DM Mono',monospace;font-size:13px;color:#555;margin-bottom:8px"></div>
      <div id="doneUid" style="font-family:'DM Mono',monospace;font-size:11px;color:#444;margin-bottom:24px"></div>
      <button class="btn-p" id="printReceiptBtn" onclick="printCoinReceipt()">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right:8px;flex-shrink:0"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>
        Print Receipt
      </button>
      <button class="btn-p" onclick="mintAnother()" style="margin-top:8px">Mint Another</button>
...
var mintedUid = null;
var mintedCount = 1;
var btcPriceMint = null;
var S = getSettings();

// Fetch BTC price for fiat display on receipt
getBtcPrice(S).then(function(p){ btcPriceMint = p; }).catch(function(){});
...
async function doMint(uid) {
  ...
  try {
    ...
    var sym = S.currencySymbol || '\u20ac';
    if (btcPriceMint) {
      var fiatVal = ((DENOMS[selectedColour] / 100000000) * btcPriceMint).toFixed(2);
      document.getElementById('doneFiat').textContent = '\u2248 ' + sym + fiatVal + ' today';
    }
...
async function printCoinReceipt() {
  var btn = document.getElementById('printReceiptBtn');
  var on = await isBridge();
  if (!on) { alert('Printer not available'); return; }
  btn.innerHTML = '<div class="spin" style="width:16px;height:16px;border-width:2px;border-top-color:#000;border-color:rgba(0,0,0,.3)"></div>';
  btn.disabled = true;
  try {
    var sym = S.currencySymbol || '\u20ac';
    var fiatLine = '';
    if (btcPriceMint) {
      fiatLine = '\u2248 ' + sym + ((DENOMS[selectedColour] / 100000000) * btcPriceMint).toFixed(2) + ' today';
    }
    var colourLabel = selectedColour.charAt(0).toUpperCase() + selectedColour.slice(1);
    await doPrint({
      storeName: 'SatsCASH',
      headerLine: colourLabel + ' Coin',
      amount: DENOMS[selectedColour].toLocaleString() + ' SATS',
      btcAmount: fiatLine,
      voucherId: mintedUid,
      qrData: '',
      issuedDate: new Date().toLocaleDateString('en-GB'),
      expiryDate: 'Mint #' + mintedCount,
      footerLine: 'Present receipt to redeem. Tap coin on phone to verify.'
    });
...
export default {
    async fetch(request, env) {
        ...
        if (path === "/app")                     return new Response(HUB,      { headers: hh });
        if (path === "/app/sale")                return new Response(SALE,     { headers: hh });
