...
const LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="34" height="34" style="flex-shrink:0">
  <rect x="0" y="0" width="500" height="500" rx="80" ry="80" fill="#FFD000"/>
  <circle cx="250" cy="250" r="190" fill="#C8C8C8" stroke="#0D0D0D" stroke-width="12"/>
  <polygon points="285,30 175,270 245,270 215,470 325,230 255,230" fill="#FFD000" stroke="#0D0D0D" stroke-width="10" stroke-linejoin="round"/>
</svg>`;
...
function logoHTML(){
  return '<div class="logo-row">${LOGO_SVG}<div style="display:flex;align-items:baseline;gap:4px"><span class="w-sats">Sats</span><span class="w-vch">VOUCHER</span></div></div>';
}
`;
